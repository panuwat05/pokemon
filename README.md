...
- 🌱 Evolution Chain
- 🔊 Pokémon Cry Audio
- 📑 Pagination using API Offset & Limit
...
```bash
git clone https://github.com/panuwat05/pokemon-project.git
```
...
- Thanks to the **Next.js**, **React**, and **Material UI** communities for providing excellent open-source technologies.
...
Made with ❤️ by **Panuwat Prasertdee**
